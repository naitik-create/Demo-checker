  ...
  try {
    ...
    const overallRows = await sequelize.query(
      `SELECT
        ...
        AVG(ds."communicationScore") AS "communicationAvg",
        AVG(ds."engagementScore") AS "engagementAvg",
        AVG(ds."structureScore") AS "structureAvg",
        AVG(ds."technicalScore") AS "technicalAvg",
        AVG(ds."qaScore") AS "qaAvg",
    ...
    res.json({
      ...
      metrics: {
        ...
        communicationAvg: overall.communicationAvg != null ? Number(overall.communicationAvg) : null,
        engagementAvg: overall.engagementAvg != null ? Number(overall.engagementAvg) : null,
        structureAvg: overall.structureAvg != null ? Number(overall.structureAvg) : null,
        technicalAvg: overall.technicalAvg != null ? Number(overall.technicalAvg) : null,
        qaAvg: overall.qaAvg != null ? Number(overall.qaAvg) : null,
